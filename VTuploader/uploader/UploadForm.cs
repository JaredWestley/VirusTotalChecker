...
namespace uploader
{
    public partial class UploadForm : DarkForm
    {
        ...
        private void Finish(bool resetText)
        {
            ...
            UploadBtn.Text = LocalizationHelper.Base.UploadForm_Upload;

            var settings = Settings.LoadSettings();

            
            var SummaryForm = new SummaryForm(settings, _fileName);
            SummaryForm.Show();
            this.Hide();
        }
        ...
        private void StartUploadThread()
        {
            ...
            UploadBtn.Text = LocalizationHelper.Base.UploadForm_Cancel;
        ...
        {
            mdTextboxsit.Text = Utils.GetMD5(_fileName);
            shaTextboxsit.Text = Utils.GetSHA1(_fileName);
            sha2Textboxsit.Text = Utils.GetSHA256(_fileName);

            settingsGroupsit.Text = LocalizationHelper.Base.UploadForm_Info;
            UploadBtn.Text = LocalizationHelper.Base.UploadForm_Upload;
